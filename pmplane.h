...
public:
   ...
   /** */
   virtual PMObject* copy() const override { return new PMPlane( *this ); }
    ...
    */
   virtual QString pixmap() const override { return QString( "pmplane" ); }
...
protected:
   ...
   /** */
   virtual int viewStructureParameterKey() const override { return s_parameterKey; }
