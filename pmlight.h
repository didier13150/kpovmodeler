...
public:
   ...
   /** */
   virtual PMObject* copy() const override { return new PMLight( *this ); }
   /** */
    ...
    * and dialog view
    */
   virtual QString pixmap() const override { return QString( "pmlight" ); }
...
protected:
   ...
   /** */
   virtual PMViewStructure* defaultViewStructure() const override { return 0; }
